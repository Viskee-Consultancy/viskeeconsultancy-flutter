class StringConstants {
  ...
  static const String PIVOT_GROUP_NAME = "PIVOT";
  static const String HJ_GROUP_NAME = "HJ";
  ...
  static const String PATH_PIVOT = "PIVOT";
  static const String PATH_HJ = "HJ";
  ...
  static const List<String> AIBT_SCHOOL_NAMES = [
    AIBT_ACE_SCHOOL_NAME,
    AIBT_BESPOKE_SCHOOL_NAME,
    AIBT_BRANSON_SCHOOL_NAME,
    AIBT_DIANA_SCHOOL_NAME,
    AIBT_EDISON_SCHOOL_NAME,
    AIBT_SHELDON_SCHOOL_NAME
  ];
  ...
  static const List<String> AIBT_I_SCHOOL_NAMES = [
    AIBT_I_BUSINESS_AND_TECHNOLOGY_SCHOOL_NAME,
    AIBT_I_EARLY_CHILDHOOD_SCHOOL_NAME,
    AIBT_I_ENGLISH_SCHOOL_NAME,
    AIBT_I_HOSPITALITY_SCHOOL_NAME,
    AIBT_I_TECH_SCIENCES_SCHOOL_NAME
  ];
  ...
  static const List<String> REACH_SCHOOL_NAMES = [
    REACH_BUSINESS_AND_TECHNOLOGY_SCHOOL_NAME,
    REACH_EARLY_CHILDHOOD_SCHOOL_NAME,
    REACH_ENGLISH_SCHOOL_NAME,
    REACH_HOSPITALITY_SCHOOL_NAME,
    REACH_TECH_SCIENCES_SCHOOL_NAME
  ];
  ...
  static const List<String> AVTA_SCHOOL_NAMES = [
    AVTA_BUSINESS_AND_TECHNOLOGY_SCHOOL_NAME,
    AVTA_EARLY_CHILDHOOD_SCHOOL_NAME,
    AVTA_ENGLISH_SCHOOL_NAME,
    AVTA_HORTICULTURE_SCHOOL_NAME,
    AVTA_HOSPITALITY_SCHOOL_NAME,
    AVTA_TECH_SCIENCES_SCHOOL_NAME
  ];
  ...
  static const List<String> NPA_SCHOOL_NAMES = [
    NPA_BUSINESS_AND_TECHNOLOGY_SCHOOL_NAME,
    NPA_EARLY_CHILDHOOD_SCHOOL_NAME,
    NPA_ENGLISH_SCHOOL_NAME,
    NPA_HOSPITALITY_SCHOOL_NAME,
    NPA_TECH_SCIENCES_SCHOOL_NAME
  ];
  ...
  static const List<String> BROOKLYN_SCHOOL_NAMES = [
    BROOKLYN_BUSINESS_AND_TECHNOLOGY_SCHOOL_NAME,
    BROOKLYN_COMMUNITY_SERVICES_SCHOOL_NAME,
    BROOKLYN_ENGLISH_SCHOOL_NAME,
    BROOKLYN_HOSPITALITY_SCHOOL_NAME,
    BROOKLYN_TECH_SCIENCES_SCHOOL_NAME
  ];

  // PIVOT School Name
  static const String PIVOT_ENGLISH_SCHOOL_NAME = "FACULTY OF ENGLISH";

  static const List<String> PIVOT_SCHOOL_NAMES = [PIVOT_ENGLISH_SCHOOL_NAME];

  // HJ School Name
  static const String HJ_BUSINESS_SCHOOL_NAME = "FACULTY OF BUSINESS";
  static const String HJ_COMMUNITY_SERVICES_SCHOOL_NAME = "FACULTY OF COMMUNITY SERVICES";
  static const String HJ_ENGINEERING_TECHNOLOGY_SCHOOL_NAME = "FACULTY OF ENGINEERING TECHNOLOGY";
  static const String HJ_ENGLISH_SCHOOL_NAME = "FACULTY OF ENGLISH";
  static const String HJ_HOSPITALITY_SCHOOL_NAME = "FACULTY OF HOSPITALITY";

  static const List<String> HJ_SCHOOL_NAMES = [
    HJ_BUSINESS_SCHOOL_NAME,
    HJ_COMMUNITY_SERVICES_SCHOOL_NAME,
    HJ_ENGINEERING_TECHNOLOGY_SCHOOL_NAME,
    HJ_ENGLISH_SCHOOL_NAME,
    HJ_HOSPITALITY_SCHOOL_NAME
  ];
  ...
  static const List<String> AIBT_FILE_NAMES = [
    AIBT_ACE_FILE_NAME,
    AIBT_BESPOKE_FILE_NAME,
    AIBT_BRANSON_FILE_NAME,
    AIBT_DIANA_FILE_NAME,
    AIBT_EDISON_FILE_NAME,
    AIBT_SHELDON_FILE_NAME
  ];
  ...
  static const List<String> AIBT_I_FILE_NAMES = [
    AIBT_I_BUSINESS_AND_TECHNOLOGY_FILE_NAME,
    AIBT_I_EARLY_CHILDHOOD_FILE_NAME,
    AIBT_I_ENGLISH_FILE_NAME,
    AIBT_I_HOSPITALITY_FILE_NAME,
    AIBT_I_TECH_SCIENCES_FILE_NAME
  ];
  ...
  static const List<String> REACH_FILE_NAMES = [
    REACH_BUSINESS_AND_TECHNOLOGY_FILE_NAME,
    REACH_EARLY_CHILDHOOD_FILE_NAME,
    REACH_ENGLISH_FILE_NAME,
    REACH_HOSPITALITY_FILE_NAME,
    REACH_TECH_SCIENCES_FILE_NAME
  ];
  ...
  static const List<String> AVTA_FILE_NAMES = [
    AVTA_BUSINESS_AND_TECHNOLOGY_FILE_NAME,
    AVTA_EARLY_CHILDHOOD_FILE_NAME,
    AVTA_ENGLISH_FILE_NAME,
    AVTA_HORTICULTURE_FILE_NAME,
    AVTA_HOSPITALITY_FILE_NAME,
    AVTA_TECH_SCIENCES_FILE_NAME
  ];
  ...
  static const List<String> NPA_FILE_NAMES = [
    NPA_BUSINESS_AND_TECHNOLOGY_FILE_NAME,
    NPA_EARLY_CHILDHOOD_FILE_NAME,
    NPA_ENGLISH_FILE_NAME,
    NPA_HOSPITALITY_FILE_NAME,
    NPA_TECH_SCIENCES_FILE_NAME
  ];
  ...
  static const List<String> BROOKLYN_FILE_NAMES = [
    BROOKLYN_BUSINESS_AND_TECHNOLOGY_FILE_NAME,
    BROOKLYN_COMMUNITY_SERVICES_FILE_NAME,
    BROOKLYN_ENGLISH_FILE_NAME,
    BROOKLYN_HOSPITALITY_FILE_NAME,
    BROOKLYN_TECH_SCIENCES_FILE_NAME
  ];

  // PIVOT File Name
  static const String PIVOT_ENGLISH_FILE_NAME = "FACULTY_OF_ENGLISH.json";

  static const List<String> PIVOT_FILE_NAMES = [PIVOT_ENGLISH_FILE_NAME];

  // HJ File Name
  static const String HJ_BUSINESS_FILE_NAME = "FACULTY_OF_BUSINESS.json";
  static const String HJ_COMMUNITY_SERVICES_FILE_NAME = "FACULTY_OF_COMMUNITY_SERVICES.json";
  static const String HJ_ENGINEERING_TECHNOLOGY_FILE_NAME = "FACULTY_OF_ENGINEERING_TECHNOLOGY.json";
  static const String HJ_ENGLISH_FILE_NAME = "FACULTY_OF_ENGLISH.json";
  static const String HJ_HOSPITALITY_FILE_NAME = "FACULTY_OF_HOSPITALITY.json";

  static const List<String> HJ_FILE_NAMES = [
    HJ_BUSINESS_FILE_NAME,
    HJ_COMMUNITY_SERVICES_FILE_NAME,
    HJ_ENGINEERING_TECHNOLOGY_FILE_NAME,
    HJ_ENGLISH_FILE_NAME,
    HJ_HOSPITALITY_FILE_NAME
  ];
  ...
  static const String PIVOT_URL = "pivot/";
  static const String HJ_URL = "hj/";
  ...
  static const String PIVOT_BROCHURE_FILE_NAME = "pivot-brochures.json";
  static const String HJ_BROCHURE_FILE_NAME = "hj-brochures.json";
  ...
  static const String PIVOT_VIDEOS_URL = "https://pivoteducation.edu.au/latest-videos/";
  static const String HJ_VIDEOS_URL = "https://hjaustralianinstitute.edu.au/latest-videos/";
  ...
  static const String PIVOT_TERMS_URL = "https://pivoteducation.edu.au/terms-and-conditions/";
  static const String HJ_TERMS_URL = "https://hjaustralianinstitute.edu.au/terms/";
  ...
  static const String PIVOT_CONTACT_URL = "https://pivoteducation.edu.au/contact-us/";
  static const String HJ_CONTACT_URL = "https://hjaustralianinstitute.edu.au/contact-us/";
}
